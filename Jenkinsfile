   ...
   stage('Check code coverage') {
            steps {
                script {
                    ...
                    def componentKey = "com.sesame:foodcatalogue"
      ...
      steps {
          ...
          sh 'docker build -t jiheneayoub1/food-catalogue-service:${VERSION} .'
          sh 'docker push jiheneayoub1/food-catalogue-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: jiheneayoub1\\/food-catalogue-service:${VERSION}/" aws/food-catalogue-manifest.yml
        '''
